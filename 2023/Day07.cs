...
public class Hand : IComparable<Hand>
{
    ...
    public int CompareTo(Hand? other)
    {
        ...
        var strongest = Strength.CompareTo(other.Strength);
        if (strongest != 0)
            return strongest;

        var faceValues = Cards.Select(v => v.Value).ToArray();
        var otherFaceValues = other.Cards.Select(v => v.Value).ToArray();
        for(var i = 0; i < faceValues.Length; i++)
        {
            var compareFaces = faceValues[i].CompareTo(otherFaceValues[i]);
            if (compareFaces != 0)
                return compareFaces;
        }
        return 0;
...
public class Day07Data
{
    public static string Test = @"32T3K 765
T55J5 684
KK677 28
KTJJT 220
QQQJA 483
";
    public static string Task = @"7KAK7 63
9889J 846
J37QA 670
T2T2J 5
827K6 552
