...
public class Program
{
	...
	{		
		...
		var data = input.Replace(Environment.NewLine, "");
		...
		for (var pos = 0; pos < connected.Length; pos++) 
		{
			if (pos >= connected.Length)
				continue;
			if (connected[pos] == 'S') {
				//Console.WriteLine($"found symbol at {pos}");
				// mark all numbers surrounding pos as connected
				for(var y = pos - width; y <= pos + width; y += width) 
				{
					for (var x = -1; x <= 1; x++)
					{						
						if (y + x >= connected.Length)
							continue;
						
						//Console.WriteLine($"pos {y + x} = {connected[y+x]}");
						if (connected[ y + x ] == 'N')
						{
							connected[ y + x ] = 'C';
						}
		...
		{
			mapSB.Append(new string(connected.Skip(width * y).Take(width).ToArray()));
			mapSB.AppendLine();
		}
		var connectionMap = mapSB.ToString();
		...
		var numbersToParse = nrs.ToString().Split(".", StringSplitOptions.RemoveEmptyEntries);
		return numbersToParse.Select(nr => int.Parse(nr)).Sum();
	}	
		
	private static string test = @"467..114..
...*......
..35..633.
......#...
617*......
...
.664.598..";
	...
	private static string task = @"...................15....904...........850.................329...................13....................................871....816....697....
