...
public class Program
{
	...
	{
		var steps = Run(Day08Data.Task);
		Console.WriteLine(steps);
		var steps2 = Run2(Day08Data.Task);
	...
	public static int Run(string input)
	{
		...
		return RunForNode(Nodes["AAA"], currentNode => currentNode.Label == "ZZZ");
	}
	
	private static void Parse(string input)
	{
		var lines = input.Split(Environment.NewLine, StringSplitOptions.RemoveEmptyEntries);
		Nodes = lines.Skip(1).Select(Node.Parse).OrderBy(n => n.Label).ToDictionary(n => n.Label);
		Path = lines[0];
	...
	public static int RunForNode(Node node, Func<Node, bool> endCondition)
	{
		...
		{
			steps++;
			routeIndex = ++routeIndex % Path.Length;
			var instruction = Path[routeIndex];
			if (instruction == 'L')
			{
...
public class Day08Data {
	public static string Test = @"LLR

AAA = (BBB, BBB)
BBB = (AAA, ZZZ)
ZZZ = (ZZZ, ZZZ)";
	public static string Task = @"
